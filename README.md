...
The latest binary release of Foxtail includes a variety of standard user-space utilities.
...
- **Why did you implement [feature] using [approach A] instead of [approach B]?**
  ...
  In hindsight, a lot of the implementations can probably be improved or refactored -- this is pretty much just the result of me following my intuition about how things should be work.
