...
CC = clang
LD = ld.lld
CFLAGS = -target i386-elf -std=c23 -m32 -ffreestanding -fno-builtin -O2 -Wall -Wextra -Wpedantic -nostdlib -I $(KERNEL_INCLUDE_DIR) -I $(SHARED_INCLUDE_DIR) -g
USER_CFLAGS = -target i386-elf -std=c23 -m32 -ffreestanding -fno-builtin -O2 -Wall -Wextra -Wpedantic -nostdlib -I $(USER_INCLUDE_DIR) -I $(SHARED_INCLUDE_DIR)
...
run: $(ISO)
	qemu-system-i386 -cdrom $(ISO) -m 1024M -d int,cpu_reset --enable-kvm -no-reboot -no-shutdown
